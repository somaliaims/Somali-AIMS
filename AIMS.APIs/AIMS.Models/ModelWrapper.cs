using AIMS.Models.DataAnnotations;
...
namespace AIMS.Models
{
    ...
    public class FinancialYearMiniView
    {
        public int FinancialYear { get; set; }
        public string Label { get; set; }
    }
    ...
    public class FinancialYearSettingView
    {
        ...
        public int CurrentFinancialYear { get; set; }
        public string CurrentFinancialYearLabel { get; set; }
        public int NextFinancialYear { get; set; }
        public string NextFinancialYearLabel { get; set; }
        public int Month { get; set; }
        public int Day { get; set; }
    }
    ...
    {
        public string Title { get; set; }
        [Required(ErrorMessage = "Please provide the logo file.")]
    ...
    public class BudgetFinancialYears
    {
        public int Year { get; set; }
        public string Label { get; set; }
    }
    ...
    public class BudgetSectorDisbursements
    {
        public int SectorId { get; set; }
        public string SectorName { get; set; }
        public int ParentSectorId { get; set; }
    ...
    public class BudgetLocationDisbursements
    {
        public int LocationId { get; set; }
    ...
    public class SearchProjectsBySectorModel
    {
        ...
        public int MarkerId2 { get; set; } = 0;
